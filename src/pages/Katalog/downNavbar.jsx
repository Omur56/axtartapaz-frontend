              ...
              <div key={cat.id} className="w-full">
                ...
                >
                  <img
                    src={cat.icon}
                    alt={cat.name}
                    className="w-[20px] h-[20px] sm:w-[20px] sm:h-[20px] md:w-[20px] md:h-[20px] xl:w-[30px] xl:h-[30px] xxl:w-[40px] xxl:h-[40px] mr-3"
                  />
                  <span className="grid grid-cols-1 sm:inline sm:text-sm font-medium text-[10px] justify-between ">
                    {cat.name}{" "}
                  </span>
