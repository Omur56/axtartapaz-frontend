...
function Header() {
 ...
 const [isFavorite, setIsFavorite] = useState(false);
  ...
  return (
    <header ref={headerRef}  className="header h-[60px] fixed  p-2   z-50  top-0 backdrop-blur-md bg-white/10 text-gray-800 shadow-none  transition-all duration-300 mb-6 w-full  " >  
