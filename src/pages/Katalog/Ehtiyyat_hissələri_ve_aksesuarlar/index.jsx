      ...
      <main className="relative z-10 mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8 pt-24 pb-28 sm:pb-12">
        ...
        <div className="mx-auto mb-8 sm:mb-10 max-w-3xl text-center">
          ...
          <div className="mt-4 flex items-center justify-center gap-3">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-400 to-orange-500 text-white shadow-lg shadow-orange-500/20">
              <Wrench size={23} />
            </div>
          ...
          >
            Ehtiyat hissəsi və ya aksesuar elanınızı yerləşdirin və məhsul
            haqqında məlumatları aşağıdakı formada qeyd edin.
          </p>
        </div>
