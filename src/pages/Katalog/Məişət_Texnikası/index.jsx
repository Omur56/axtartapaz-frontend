      ...
      <main className="relative z-10 mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8 pt-24 pb-28 sm:pb-12">
        ...
        <div className="mx-auto mb-8 sm:mb-10 max-w-3xl text-center">
          ...
          <div className="mt-4 flex items-center justify-center gap-3">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-rose-400 to-pink-600 text-white shadow-lg shadow-pink-500/20">
          ...
          >
            Məişət texnikası məhsulunuz üçün elan yaradın və məhsul haqqında
