...
//     // Backend portunu açıq yazırıq (3000 proxy işləməyəcək)
...
// //     // İstifadəçini MilliÖN ödəniş səhifəsinə yönləndir
...
const Home = () => {
  ...
  const currentUserId = localStorage.getItem("userId"); // login zamanı saxlanmalı
                  ...
                  <div className="bg-white w-full h-[300px] rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 ease-in-out overflow-hidden flex flex-col">
                    ...
                    <div className="absolute top-2 right-2 flex gap-2 z-999">
                      ...
                      {item.upgrade === "premium" && (
                        <div className="w-6 h-6 flex items-center justify-center bg-red-500 rounded-full text-white">
                          <Star size={16} strokeWidth={1.5} />
                        </div>
                      )}
                    </div>
